...
\begin{figure}[H]
\includegraphics[width=16.0cm]{../plots/ising_25.pdf}
\caption{Plot of the magnetization $M$ over $L$ with double logarithmic scale. The resulting curve is almost linear.}
\end{figure}
